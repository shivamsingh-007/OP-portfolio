...
export default function Hero() {
  ...
  const mx = (mouse.x / (window.innerWidth || 1) - 0.5) * 8;
  const my = (mouse.y / (window.innerHeight || 1) - 0.5) * 5;
  ...
  return (
    <section ref={heroRef} id="hero" style={{
      ...
      {/* Spider-Man image background — centered, covers entire viewport */}
      <div style={{
        position: 'absolute',
        top: '50%', left: '50%',
      ...
      {/* Content — Shivam left, Singh right */}
      <div style={{
        ...
        {/* Name split: Shivam left, Singh right */}
        <div style={{
